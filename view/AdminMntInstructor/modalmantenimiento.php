        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="instructor_form">
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Apellido Parterno: <span class="tx-danger">*</span> </label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="inst_telef" type="text" name="inst_telef" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Sexo: <span class="tx-danger">*</span> </label>
                            <select class="form-control select2" style="width: 100%" data-placeholder="Seleccione" name="inst_sex" id="inst_sex">
