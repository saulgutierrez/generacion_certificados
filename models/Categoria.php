<?php
    class Categoria extends Conectar {
        public function insert_categoria($cat_id, $cur_nom, $cur_descrip, $cur_fech_ini, $cur_fech_fin, $inst_id) {
        ...
        public function update_categoria($cur_id,$cat_id, $cur_nom, $cur_descrip, $cur_fech_ini, $cur_fech_fin, $inst_id) {
            $conectar = parent::Conexion();
            parent::set_names();
            $sql = "UPDATE tm_curso
                    SET
